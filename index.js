...
const token4 = "EAACMbNwv3J4BAIJl5N20veX0GXCYTSCXNcjN6X1tRRYqimCdYXiy3QTEztcxhPFkaQU3UalnT8pkMPaxe1ISkEdttsfzt1uLZBQBqCQ2gUzWManCnDTXtEMazjppS4ISKaUPH8gbf6bfYJ9swI9TAzD2DujkIPYAXZC840mAZDZD"
function gettoken(page_id) {
	if (page_id == "122194738430561") {
		 return token3;
	}
	
	if (page_id == "674719415958928") {
		return token4;
	}
